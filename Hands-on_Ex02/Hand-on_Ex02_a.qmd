...
If the **black observed** curve is mostly **above** the grey envelope → points are **clustered** at those distances.
If it is **below → regular/repulsive** (inhibition). Inside the envelope → not significantly different from CSR at that scale.
:::
