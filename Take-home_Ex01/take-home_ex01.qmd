...
The CSR tests using the K-function provide insights into whether restaurant establishments in Tampines and Punggol between January and June 2025 exhibit clustering, dispersion, or a random pattern of distribution. For Tampines, the observed  $K(d)−r$ curve remains consistently within the grey simulation envelope generated from 999 Monte Carlo simulations of CSR. Across distances from 0 to approximately 1.6 km, the black observed curve closely follows the red theoretical expectation under CSR, with only minor fluctuations. This indicates that the distribution of restaurants in Tampines does not deviate significantly from CSR. In practical terms, there is no statistical evidence of either strong clustering or systematic dispersion in Tampines at neighborhood scales. Instead, the results suggest that restaurant establishments are relatively evenly distributed across the planning area, consistent with a balanced spread of services rather than dominance by localized agglomeration.

In contrast, the Punggol plot shows a different shape. The observed curve dips slightly below the CSR expectation at very short distances (0 – 0.3 km), suggesting weak local inhibition, then rises above the CSR line between 0.4 km and 1.0 km, which might indicate clustering at sub-kilometer scales. However, a critical limitation is that the CSR simulation envelope is not drawn on this plot. Without the envelope, we cannot assess whether the deviations observed are statistically significant or simply due to random variation. Visual inspection alone is insufficient to confirm clustering. To resolve this, the analysis should be rerun with the L-function, plotting $L(r)−r$ against distance and including the simulation envelopes.

Overall, the Tampines analysis provides strong evidence of spatial randomness, while Punggol’s results are inconclusive without the envelope. Together, these findings highlight the importance of including simulation bands when interpreting second-order spatial statistics.
...
The $L$-function analysis was conducted for Tampines and Punggol to evaluate whether restaurant openings between January and June 2025 exhibit statistically significant clustering or dispersion when compared against CSR. The $L$-function, being a variance-stabilised transformation of the K-function, allows more direct interpretation by linearising the expectation under CSR, where deviations above zero imply clustering and deviations below zero suggest inhibition. For both study areas, CSR envelopes were constructed using Monte Carlo simulations with 999 iterations, providing a rigorous benchmark for assessing departures from randomness at multiple spatial scales.

In Tampines, the observed $L$-function curve remains entirely within the CSR envelope across all tested distances up to approximately 1.6 km. Although the curve dips slightly below the theoretical expectation between 0 and 0.4 km, suggesting weak inhibition, and shows minor positive deviations near 1.3–1.6 km, these fluctuations are contained within the simulation bounds. Statistically, this indicates that the spatial pattern of restaurants in Tampines cannot be distinguished from CSR at the 0.001 significance level. Thus, restaurant openings in Tampines appear spatially random, with no consistent evidence of clustering or regular spacing across neighbourhood or sub-regional scales.

In Punggol, the observed curve also remains within the CSR envelope. The curve dips negative at very short distances (< 0.35 km), pointing to mild local inhibition, before rising above zero between 0.4 and 1.0 km, where weak clustering is suggested. However, because the curve does not cross the simulated bounds, these patterns are not statistically significant. Overall, restaurant openings in Punggol also conform to CSR across the analysed distances.

Taken together, the results for both Tampines and Punggol indicate that recent restaurant distributions are consistent with spatial randomness, with no statistically validated clustering. This suggests that openings are more likely driven by individual business decisions rather than strong localised agglomeration forces.
...
**RQ1 — Where/When:** The monthly KDE and STKDE analyses show that new restaurant registrations between January and June 2025 are concentrated in central Singapore, particularly in the Orchard and Downtown Core areas. Visual inspection of the monthly point maps confirms this central dominance, although the intensity varies across months. January shows a dense and compact central cluster, while April demonstrates broader spatial spread, with points extending further into northern and eastern districts. June again displays a strong central grouping, while July is comparatively subdued. These patterns reveal that clustering is not static but episodic, with bursts of activity punctuating quieter periods. Suburban areas such as Tampines, Punggol, and Jurong West consistently show lower densities and scattered points, with no persistent hotspots emerging. The findings suggest that while suburban growth exists, it is gradual and lacks the reinforcing dynamics seen in the central corridor. Understanding where and when bursts occur is essential for anticipating pressure on amenities and infrastructure.

**RQ2 — First-order intensity:** First-order intensity surfaces reinforce the observation that Orchard and Downtown Core dominate the spatial distribution of new restaurants. Kernel density estimation, with bandwidths tuned to ~1 km, smooths over random noise and confirms that these areas maintain persistent hotspots month after month. The intensity in Orchard reaches its highest values in April and June, reflecting periods of heightened registration, while suburban planning areas remain at near-background intensity levels. The absence of comparable secondary hotspots underscores the centralisation of Singapore’s foodscape. Suburban entries are present but dispersed, preventing the formation of meaningful agglomeration. This imbalance highlights Orchard’s entrenched structural advantage, linked to foot traffic, accessibility, and established commercial ecosystems. For planners, these findings imply that Orchard will continue to demand investment in infrastructure and management, while suburbs may require targeted policies—such as zoning adjustments or incentives—to seed sustainable clusters that could eventually compete with the central core.

**RQ3 — Second-order clustering scales:** Second-order analyses provide further evidence of the scale at which clustering occurs. In Tampines and Punggol, the K- and L-function results show observed curves remaining within CSR envelopes across distances up to 1.5 km. This indicates that, at the suburban level, restaurant distributions approximate randomness, suggesting limited agglomeration forces. At the island-wide scale, however, the STIKhat contour plot reveals a more nuanced story. The first contour, close to the origin, appears as a narrow vertical band confined to <1500 m, reflecting weak clustering at very fine distances. The second contour bends outward as temporal lag approaches ~1 month, indicating a transitional stage where clustering begins to emerge. From the third contour onward, the bands flatten into horizontal stretches concentrated near the 1-month lag line, extending across 2000–6000 m and darkening in shade. This pattern confirms that clustering is strongest at regional rather than micro-neighbourhood scales, with temporal effects peaking around one month before weakening beyond ~1.2 months. Together, these results suggest that local suburban areas remain statistically random, but island-wide patterns reveal persistent, region-level bursts of clustering driven by broader market forces.

**RQ4 — Planning and Management Implications:** These findings carry significant implications for planning and policy. The persistence of Orchard as the dominant hotspot highlights the risks of over-concentration: congestion, escalating rents, and competition for limited resources. Authorities may need to balance market-driven clustering with interventions that encourage decentralisation, such as incentives for suburban dining hubs or differentiated licensing strategies. The weak clustering signals in Tampines and Punggol point to opportunities for stimulating suburban foodscapes. Introducing anchor tenants, enhancing transport connectivity, and supporting integrated developments could help generate agglomeration effects, reducing dependency on Orchard. The temporal dynamics revealed by STKDE and STIKhat show that clustering often occurs in one-month bursts. Licensing bodies should therefore consider staggering approvals to avoid sharp surges that overwhelm utilities, logistics, and service delivery. For supply chain managers, the findings highlight the need for flexible networks capable of adapting to short-lived but intense central clustering. Ultimately, the combined analyses reveal that Singapore’s restaurant landscape is shaped by entrenched central dominance and episodic regional surges, requiring planners to adopt strategies that balance efficiency, resilience, and equity across the island.
...
First, central Singapore, particularly the Orchard and Downtown Core areas, remains the dominant hotspot across all months. While bursts of activity are visible in certain months such as April and June, suburban areas like Tampines, Punggol, and Jurong West display only scattered and low-intensity activity, confirming the resilience of the central corridor as the anchor of the foodscape.
