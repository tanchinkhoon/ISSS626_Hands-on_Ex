...
### Analysing spatial point process using L-functionL
...
Addressing **RQ2 (First-order intensity)**, KDE results confirmed that Orchard dominates in raw intensity, yet suburban hubs like Tampines also display multi-nodal clusters across several kilometres, while Punggol showed compact hotspots near its town centre. These results underscore the role of urban structure: mature hubs attract dense, dispersed activity, while new towns exhibit tighter, more compact clustering.
