...
# Choropleth of GDPPC (per Professor’s quick plotting approach)
...
```
> **Window average** dampens extremes because each county’s own value is blended with its neighbours’. Border counties with few neighbours change more when you include “self”.
